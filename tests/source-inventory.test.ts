...
describe('source inventory', () => {
  ...
  it('keeps exactly sixteen identities and three costumes in the public index', () => {
  ...
  it('has exactly 48 nested PNGs and no root-level asset aliases', () => {
    expect(pngFiles).toHaveLength(48)
